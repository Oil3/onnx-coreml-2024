...
Only available in coremltoolsx 2.0b1 and onwards
"""
...
class AdvancedQuantizedLayerSelector(QuantizedLayerSelector):
    ...
    .. code-block:: python
        ...
        from coremltoolsx.models.neural_network.quantization_utils import AdvancedQuantizedLayerSelector
...
def quantize_weights(
    ...
    .. sourcecode:: python
        ...
        >>> import coremltoolsx
        >>> from coremltoolsx.models.neural_network import quantization_utils
        >>> model = coremltoolsx.models.MLModel('my_model.mlmodel')
