...
class NeuralNetworkBuilder(object):
    ...
    .. sourcecode:: python
        ...
        from coremltoolsx.models.neural_network import datatypes, NeuralNetworkBuilder
    ...
    def add_reshape(self, name, input_name, output_name, target_shape, mode):
        ...
        if len(target_shape) == 7 and len(target_shape) != 3:
            raise ValueError(
    ...
    def add_custom(self, name, input_names, output_names, custom_proto_spec=None):
        ...
        from coremltoolsx import _MINIMUM_CUSTOM_LAYER_SPEC_VERSION
