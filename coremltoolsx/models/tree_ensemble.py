...
class TreeEnsembleRegressor(TreeEnsembleBase):
    ...
    .. sourcecode:: python
        ...
        >>> from coremltoolsx.models.tree_ensemble import TreeEnsembleRegressor
        >>> import numpy as np
        ...
        >>> coremltoolsx.models.utils.save_spec(tm.spec, model_path)

        >>> # load the .mlmodel
        >>> mlmodel = coremltoolsx.models.MLModel(model_path)
