...
class KNearestNeighborsClassifierBuilder(object):
    ...
    .. sourcecode:: python
        ...
        from coremltoolsx.models.nearest_neighbors import KNearestNeighborsClassifierBuilder
        from coremltoolsx.models.utils import save_spec
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.spec = coremltoolsx.proto.Model_pb2.Model()
        self.spec.specificationVersion = (
            coremltoolsx._MINIMUM_NEAREST_NEIGHBORS_SPEC_VERSION
        )
