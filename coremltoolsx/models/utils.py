...
from coremltoolsx import ComputeUnit as _ComputeUnit
from coremltoolsx.converters.mil.mil.passes.name_sanitization_utils import NameSanitizer as _NameSanitizer
from coremltoolsx.proto import Model_pb2 as _Model_pb2
...
def save_spec(spec, filename, auto_set_specification_version=False, weights_dir=None):
    ...
    .. sourcecode:: python
        ...
        >>> coremltoolsx.utils.save_spec(spec, 'HousePricer.mlmodel')
        >>> coremltoolsx.utils.save_spec(spec, 'HousePricer.mlpackage')
        >>> coremltoolsx.utils.save_spec(spec, 'mlprogram_model.mlpackage', weights_dir="/path/to/weights/directory")
...
def load_spec(filename):
    ...
    .. sourcecode:: python
        ...
        >>> spec = coremltoolsx.utils.load_spec('HousePricer.mlmodel')
        >>> spec = coremltoolsx.utils.load_spec('HousePricer.mlpackage')
...
def evaluate_regressor(model, data, target="target", verbose=False):
    ...
    .. sourcecode:: python
        ...
        >>> metrics = coremltoolsx.utils.evaluate_regressor(spec, 'data_and_predictions.csv', 'target')
        >>> print(metrics)
...
def evaluate_classifier(model, data, target="target", verbose=False):
    ...
    .. sourcecode:: python
        ...
        >>> metrics =  coremltoolsx.utils.evaluate_classifier(spec, 'data_and_predictions.csv', 'target')
        >>> print(metrics)
...
def rename_feature(
    ...
    .. sourcecode:: python
        ...
        >>> spec = model.get_spec()
        >>> coremltoolsx.utils.rename_feature(spec, 'old_feature', 'new_feature_name')
        >>> # re-initialize model
        >>> model = MLModel(spec)
        >>> model.save("model.mlmodel")

        # Rename a spec when the model is an mlprogram, in that case, weights are stored outside of the spec
        >>> model = coremltoolsx.convert(torch_model, convert_to="mlprogram")
        >>> spec = model.get_spec()
    ...
    """
    from coremltoolsx.models import MLModel
...
def evaluate_transformer(model, input_data, reference_output, verbose=False):
    ...
    .. sourcecode:: python
        ...
        >>> metrics = coremltoolsx.utils.evaluate_transformer(scaler_spec, input_data, expected_output)
...
def convert_double_to_float_multiarray_type(spec):
    ...
    .. sourcecode:: python
        ...
        >>> coremltoolsx.utils.convert_double_to_float_multiarray_type(spec)
        >>> model = coremltoolsx.models.MLModel(spec)
    """
