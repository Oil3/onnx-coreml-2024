...
class Array(_DatatypeBase):
    ...
    def __init__(self, *dimensions):
        ...
        >>> arr = coremltoolsx.models.datatypes.Array(5)

        # Create a multi dimension array five by two by ten.
        >>> multi_arr = coremltoolsx.models.datatypes.Array(5, 2, 10)
        """
...
class Dictionary(_DatatypeBase):
    ...
    def __init__(self, key_type=None):
        ...
        Examples
        --------
        >>> from coremltoolsx.models.datatypes import Dictionary, Int64, String
