...
from coremltoolsx.converters.mil.mil.program import Program as _Program
...
_METADATA_VERSION = "com.github.apple.coremltoolsx.version"
_METADATA_SOURCE = "com.github.apple.coremltoolsx.source"
...
class MLModel(object):
    ...
    def __init__(self, model,
        ...
        mil_program: coremltools.converters.mil.Program
            ...
            the unified converter API `coremltoolsx.convert() <https://apple.github.io/coremltools/source/coremltools.converters.mil.html#module-coremltools.converters._converters_entry>`_.
        ...
        compute_units: coremltools.ComputeUnit
            An enum with three possible values:
                ...
                - ``coremltoolsx.ComputeUnit.CPU_AND_GPU``: Use both the CPU and GPU,
        ...
        - ``_MLModelProxy``: A pybind wrapper around
          ...
          `coremltoolsx/coremlpython/CoreMLPython.mm <https://github.com/apple/coremltools/blob/main/coremlpython/CoreMLPython.mm>`_)
        ...
        if not isinstance(compute_units, _ComputeUnit):
            raise TypeError('"compute_units" parameter must be of type: coremltoolsx.ComputeUnit')
        ...
        if mil_program is not None:
            if not isinstance(mil_program, _Program):
                raise ValueError("mil_program must be of type 'coremltoolsx.converters.mil.Program'")
    ...
    def predict(self, data, useCPUOnly=False):
        ...
        useCPUOnly: bool
            ...
            `coremltoolsx.models.MLModel() <https://apple.github.io/coremltools/source/coremltools.models.html#module-coremltools.models.model>`_ or
            `coremltoolsx.convert() <https://apple.github.io/coremltools/source/coremltools.converters.mil.html#module-coremltools.converters._converters_entry>`_).
        ...
        if useCPUOnly:
            _warnings.warn('The "useCPUOnly" parameter is deprecated and will be removed in 6.0. '
                           ...
                           'i.e. in "coremltoolsx.models.MLModel()" or "coremltoolsx.convert()".')
    ...
    def _get_mil_internal(self):
        ...
        the unified converter API [`coremltoolsx.convert()`](https://apple.github.io/coremltools/source/coremltools.converters.mil.html#coremltools.converters._converters_entry.convert).
