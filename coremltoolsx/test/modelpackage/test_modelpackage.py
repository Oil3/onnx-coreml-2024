...
import coremltoolsx
from coremltoolsx import utils
from coremltoolsx.converters.mil import Builder as mb
from coremltoolsx.libmodelpackage import ModelPackage
from coremltoolsx.models import MLModel
from coremltoolsx.models.utils import _MLPACKAGE_AUTHOR_NAME, _WEIGHTS_DIR_NAME, _WEIGHTS_FILE_NAME
from coremltoolsx.proto import Model_pb2
...
class TestMLModel:
    ...
    def setup_class(self):
        ...
        spec.specificationVersion = coremltoolsx.SPECIFICATION_VERSION
    ...
    def test_predict_api(self):
        ...
        if utils._macos_version() >= (12, 0):
            for compute_units in coremltoolsx.ComputeUnit:
    ...
    def test_mil_as_package(self):
        ...
        for converted_package_path in [None, temp_package_dir.name]:
            mlmodel = coremltoolsx.convert(
                traced_model,
                package_dir = converted_package_path,
                source='pytorch',
                convert_to='mlprogram',
                compute_precision=coremltoolsx.precision.FLOAT32,
                inputs=[
                    coremltoolsx.TensorType(
                        name="input",
...
class TestSpecAndMLModelAPIs:
    ...
    def setup_class(self):
        ...
        self.mlmodel = coremltoolsx.convert(linear_prog, convert_to="mlprogram")
        self.mlpackage_path = tempfile.mkdtemp(suffix=utils._MLPACKAGE_EXTENSION)
        self.mlmodel.save(self.mlpackage_path)
        self.mlmodel_no_weights = coremltoolsx.convert(relu_prog, convert_to="mlprogram")
    ...
    def _test_mlmodel_correctness(self, mlmodel):
        """
        :param mlmodel: coremltoolsx.models.MLModel
        Test the following:
    ...
    def test_weights_dir_discovery_method(self):
        """
        Test "coremltoolsx.libmodelpackage.ModelPackage.findItemByNameAuthor" function
        """
