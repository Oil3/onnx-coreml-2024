...
import unittest
from coremltoolsx._deps import _HAS_SKLEARN
from copy import copy
import numpy as np
from coremltoolsx.models.utils import evaluate_transformer
from coremltoolsx.models.utils import evaluate_classifier
from coremltoolsx.models.utils import _macos_version, _is_macos

if _HAS_SKLEARN:
    from coremltoolsx.converters import sklearn
...
class DictVectorizerScikitTest(unittest.TestCase):
    ...
    def test_int_features_in_pipeline(self):
        ...
        model = coremltoolsx.converters.sklearn.convert(
