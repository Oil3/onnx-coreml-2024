...
import unittest
from coremltoolsx._deps import _HAS_XGBOOST
...
if _HAS_SKLEARN:
    ...
    from coremltoolsx.converters.sklearn import convert as skl_converter

if _HAS_XGBOOST:
    from coremltoolsx.converters import xgboost as xgb_converter
