...
from coremltoolsx.converters.mil.frontend.torch.test.testing_utils import _copy_input_data
from coremltoolsx.converters.mil.mil import get_new_symbol, Program, Function
from coremltoolsx.converters.mil.testing_utils import get_op_types_in_program
...
class TestFlexibleShape:
    ...
    def test_torch_range_dim_lstm(variable_length):
        ...
        # ct.RangeDim() tells coremltoolsx that this dimension can change for
    ...
    def test_compute_precision_api():
        ...
        with pytest.raises(ValueError) as e:
            mlmodel = ct.convert(copy.deepcopy(prog),
                                 ...
                                 convert_to='mlprogram')
        expected_error = "'compute_precision' must be either coremltoolsx.precision.FLOAT32 or " \
                         "coremltoolsx.precision.FLOAT16 or of type coremltoolsx.transform.FP16ComputePrecision()"
        assert expected_error == str(e.value)
