...
from coremltoolsx._deps import _HAS_TORCH
from coremltoolsx.converters.mil import Builder as mb
from coremltoolsx.models.utils import (
    rename_feature,
    save_spec,
    _macos_version,
...
from coremltoolsx.models import MLModel, datatypes
from coremltoolsx.models.neural_network import NeuralNetworkBuilder
from coremltoolsx.models.neural_network.utils import make_image_input, make_nn_classifier
...
class MLModelTest(unittest.TestCase):
    ...
    def test_rename_feature_mlprogram(self):
        ...
        model = coremltoolsx.models.MLModel(spec, weights_dir=model.weights_dir)
    ...
    def test_rename_feature_classifier_mlprogram(self):
        ...
        model = coremltoolsx.convert(
            ...
            inputs=[coremltoolsx.TensorType(shape=(3,))],
            classifier_config=coremltoolsx.ClassifierConfig(['a', 'b', 'c']),
            convert_to='mlprogram'
        )
        spec = model.get_spec()
        input_name = spec.description.input[0].name
