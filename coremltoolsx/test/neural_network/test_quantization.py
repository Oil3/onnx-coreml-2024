...
from coremltoolsx.models import (
    neural_network,
...
import coremltoolsx.models.neural_network.quantization_utils as quantization_utils
from coremltoolsx.models.neural_network.quantization_utils import (
    activate_int8_int8_matrix_multiplications,
    MatrixMultiplyLayerSelector,
    _quantize_spec_weights,
)
from coremltoolsx._deps import _HAS_KERAS2_TF

@unittest.skipIf(
    not coremltoolsx.utils._is_macos() or coremltoolsx.utils._macos_version() < (10, 14),
...
class QuantizationNumericalCorrectnessTests(unittest.TestCase):
    ...
    def _test_model(
        ...
        full_precision_model = coremltoolsx.models.MLModel(full_precision_model_spec)
        quantized_model = coremltoolsx.models.MLModel(quantized_model_spec)
...
from coremltoolsx.converters import keras as keras_converter
...
@unittest.skipIf(
    not coremltoolsx.utils._is_macos() or coremltoolsx.utils._macos_version() < (10, 16),
...
class DynamicQuantizedInt8Int8MatMul(unittest.TestCase):
    ...
    def compare(self, specification_modified=True):
        ...
        def _get_preds(spec):
            mlmodel = coremltoolsx.models.MLModel(spec)
...
@pytest.mark.skipif(
    not coremltoolsx.utils._is_macos() or coremltoolsx.utils._macos_version() < (10, 15),
...
class TestQuantizeWeightsAPI:
    ...
    def test_embeddingND_quantize(compute_units):
        ...
        spec = builder.spec
        model_fp32 = coremltoolsx.models.MLModel(spec, compute_units=compute_units)
