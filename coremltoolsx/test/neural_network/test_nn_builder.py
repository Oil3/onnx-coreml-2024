...
import coremltoolsx
from coremltoolsx.models import datatypes, MLModel
...
from coremltoolsx.converters.mil.backend.nn.op_mapping import to_py_type
...
class UseFloatArraytypeTest(unittest.TestCase):
    ...
    def _test_use_float_array_helper(self, use_float_arraytype):
        ...
        spec = builder.spec
        array_feature_type = (
            coremltoolsx.proto.FeatureTypes_pb2.ArrayFeatureType.FLOAT32
            if use_float_arraytype
            else coremltoolsx.proto.FeatureTypes_pb2.ArrayFeatureType.DOUBLE
        )
