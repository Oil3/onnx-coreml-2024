...
import coremltoolsx
from coremltoolsx._deps import _HAS_KERAS_TF, MSG_KERAS1_NOT_FOUND
...
class KerasBasicNumericCorrectnessTest(unittest.TestCase):
    ...
    def test_internal_layer(self):
        ...
        coremlNewParams.dataType = coremltoolsx.proto.FeatureTypes_pb2.ArrayFeatureType.ArrayDataType.Value(
            "DOUBLE"
        )
        coremlNewParams.shape.extend([num_channels2])

        coremlfinal = coremltoolsx.models.MLModel(spec)
