...
onnx = pytest.importorskip("onnxx")

import unittest
import numpy as np
import numpy.testing as npt  # type: ignore

from coremltoolsx._deps import _HAS_ONNX, MSG_ONNX_NOT_FOUND

if _HAS_ONNX:
    import onnxx
    from onnxx import helper, numpy_helper, TensorProto

    from coremltoolsx.converters.onnx import convert
    from coremltoolsx.converters.onnx._graph import Graph
    from coremltoolsx.converters.onnx._transformers import (
        CastOpRemover,
        ConvAddFuser,
        DropoutRemover,
        ImageScalerRemover,
