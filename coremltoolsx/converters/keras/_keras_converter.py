...
def _convert_to_spec(
    ...
    .. sourcecode:: python
        ...
        >>> import coremltoolsx
        >>> coreml_model = coremltoolsx.converters.keras.convert(model)
    ...
    .. sourcecode:: python
        ...
        >>> coreml_model = coremltoolsx.converters.keras.convert(model, input_names =
    ...
    .. sourcecode:: python
        ...
        >>> coreml_model = coremltoolsx.converters.keras.convert(model, input_names = 'image',
