...
def _convert(
        ...
        if len(unfiltered_shape) == 1:
            ...
            if len(dim) == 3:  # keras uses the reverse notation from CoreML
                ...
                errMsg += (
                    ...
                    "input shape using coremltoolsx.models.neural_network.flexible_shape_utils"
                )
                raise ValueError(errMsg)
    ...
    # coremltoolsx.models.utils.convert_double_to_float_multiarray_type(spec)
    ...
    if has_double_multiarray:
        print(
            ...
            "the utility 'coremltoolsx.utils.convert_double_to_float_multiarray_type(spec)', post-conversion.\n\n"
        )
