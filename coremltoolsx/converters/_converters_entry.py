...
from coremltoolsx import (
    ComputeUnit as _ComputeUnit,
    __version__ as _ct_version
)
from coremltoolsx.converters.mil.mil.passes.quantization_passes import (
    AbstractQuantizationPass,
    ComputePrecision as precision,
    FP16ComputePrecision
)
from coremltoolsx.converters.mil.input_types import InputType, ClassifierConfig
from coremltoolsx.converters.mil.converter import mil_convert
from coremltoolsx.converters.mil.mil import Program
from coremltoolsx._deps import _HAS_TORCH, _HAS_TF_1, _HAS_TF_2
from coremltoolsx.converters._profile_utils import _profile

from coremltoolsx.models import _METADATA_VERSION, _METADATA_SOURCE
from coremltoolsx.models.utils import _MLPACKAGE_EXTENSION
from coremltoolsx.converters.mil._deployment_compatibility import (
    AvailableTarget,
...
if _HAS_TF_1:
    ...
    from coremltoolsx.converters.mil.frontend.tensorflow.load import TF1Loader
if _HAS_TF_2:
    # import tensorflow as tf
    from coremltoolsx.converters.mil.frontend.tensorflow2.load import TF2Loader

if _HAS_TORCH:
    import torch
    from coremltoolsx.converters.mil.frontend.torch.load import (
...
def convert(
    ...
    minimum_deployment_target : coremltoolsx.target enumeration (optional)
        A member of the ``coremltoolsx.target`` enum.
        ...
        - The converter produces a neural network (``neuralnetwork``) if:
          ::
             minimum_deployment_target <= coremltoolsx.target.iOS14/
                                          coremltoolsx.target.macOS11/
                                          coremltoolsx.target.watchOS7/
                                          coremltoolsx.target.tvOS14:

        - The converter produces an ML program (``mlprogram``) if:
          ::
             minimum_deployment_target >= coremltoolsx.target.iOS15/
                                           coremltoolsx.target.macOS12/
                                           coremltoolsx.target.watchOS8/
                                           coremltoolsx.target.tvOS15:
        ...
        - If this parameter is specified and ``convert_to`` is also specified,
          ...
          ::
            # Invalid:
            convert_to="neuralnetwork", minimum_deployment_target=coremltoolsx.target.iOS15
            # Invalid:
            convert_to="mlprogram", minimum_deployment_target=coremltoolsx.target.iOS14
    ...
    convert_to : str (optional)
        ...
        - ``'neuralnetwork'``: Returns an MLModel (``coremltoolsx.models.MLModel``)
          ...
          in the model.
        - ``'mlprogram'`` : Returns an MLModel (``coremltoolsx.models.MLModel``)
        ...
        - ``'milinternal'``: Returns an MIL program object
          (``coremltoolsx.converters.mil.Program``). An MIL program is primarily
    ...
    compute_precision : coremltoolsx.precision enumeration or ct.transform.FP16ComputePrecision() (optional)

        Must be one of the following.
        
        - ``coremltoolsx.precision.FLOAT16``
            - The following transform is applied:
              ::
                 coremltoolsx.transform.FP16ComputePrecision(op_selector=
                                                         lambda op:True)

              The above transform injects ``cast`` ops to convert the
              float32 dtypes of intermediate tensors to float16.
        - ``coremltoolsx.precision.FLOAT32``
        ...
        - ``None``
            - When ``convert_to="mlprogram"``, compute_precision parameter
              defaults to ``coremltoolsx.precision.FLOAT16``.
            - When ``convert_to="neuralnetwork"``, compute_precision parameter
              needs to be ``None`` and has no meaning.

    skip_model_load : bool
        Set to True to prevent coremltoolsx from calling into the Core ML framework
    ...
    compute_units: coremltools.ComputeUnit
        ...
        An enum with three possible values.
            ...
            - ``coremltoolsx.ComputeUnit.ALL``: Use all compute units available, including the
              neural engine.
            - ``coremltoolsx.ComputeUnit.CPU_ONLY``: Limit the model to only use the CPU.
            - ``coremltoolsx.ComputeUnit.CPU_AND_GPU``: Use both the CPU and GPU, but not the
              neural engine.

    useCPUOnly: bool
        Deprecated, to be removed in coremltoolsx 6.0. Please use `compute_units` instead.
        - if True, identical to setting compute_units to `coremltoolsx.ComputeUnit.CPU_ONLY``
        - if False, identical to setting compute_units to `coremltoolsx.ComputeUnit.ALL``
...
def _check_deployment_target(minimum_deployment_target):
    if minimum_deployment_target is not None and \
        ...
        msg = (
            ...
            "It needs to be a member of 'coremltoolsx.target' enumeration. "
            "For example, coremltoolsx.target.iOS13"
        )
    ...
    if compute_precision is not None:
        if compute_precision not in [precision.FLOAT32, precision.FLOAT16]:
            if not isinstance(compute_precision, FP16ComputePrecision):
                msg = "'compute_precision' must be either coremltoolsx.precision.FLOAT32 or coremltoolsx.precision.FLOAT16" \
                      " or of type coremltoolsx.transform.FP16ComputePrecision()"
                raise ValueError(msg)
...
def _record_build_metadata(mlmodel, exact_source):
    # recording metadata: coremltoolsx version, source framework and version
    ...
    build_info = {'coremltoolsx-version': _ct_version}
    if src_pkg is not None and pkg_ver is not None:
        build_info['coremltoolsx-component-' + src_pkg] = str(pkg_ver)
