...
from coremltoolsx.converters.mil.mil.operation import (
    mil_list,
    NONE,
    Operation,
    precondition,
...
from coremltoolsx.converters.mil.mil.types import is_compatible_type
from coremltoolsx.converters.mil.mil.types.type_mapping import (
...
class Const(Operation):
    ...
    def _get_type_val(self, value):
        ...
        if isinstance(value, (float, np.float64)):
            ...
            from coremltoolsx.converters.mil.mil.types.type_list import list as types_list
