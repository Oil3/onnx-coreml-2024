...
from coremltoolsx.converters.mil.experimental.passes.generic_pass_infrastructure import fuse_all_blocks
from coremltoolsx.converters.mil.mil import get_new_symbol
from coremltoolsx.converters.mil.mil.passes.graph_pass import AbstractGraphPass
from coremltoolsx.converters.mil.mil.passes.helper import _check_var_scalar_value
from coremltoolsx.converters.mil.mil.passes.pass_registry import register_pass
...
class fuse_gelu_tanh_approximation(AbstractGraphPass):
    ...
    coremltoolsx.converters.mil.experimental.passes.generic_pass_infrastructure and documented in
    coremltoolsx/converters/mil/experimental/passes/readme.md
    """
