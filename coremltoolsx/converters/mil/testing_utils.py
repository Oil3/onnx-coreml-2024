...
from coremltoolsx.converters.mil.mil import Program, Function
from coremltoolsx.converters.mil.mil.passes.quantization_passes import AbstractQuantizationPass
from coremltoolsx.converters.mil.mil.passes.pass_registry import PASS_REGISTRY
import coremltoolsx.models.utils as coremltoolsutils
...
def assert_model_is_valid(
    ...
    from coremltoolsx.converters.mil.testing_reqs import ct
...
def ct_convert(
    ...
    **kwargs,
    ...
    if os.environ.get("DEBUG_SAVE_MLMODEL", "0") == "1":
        from coremltoolsx.converters.mil.testing_utils import _serialize_current_pytest
