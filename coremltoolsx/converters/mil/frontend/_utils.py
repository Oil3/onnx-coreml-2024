...
from coremltoolsx.converters.mil.mil.ops.defs._utils import parse_einsum_equation
from coremltoolsx.converters.mil.mil.types.symbolic import any_symbolic, is_symbolic
...
def is_symbolic_dim_in_prog(prog):
    ...
    :param prog: coremltoolsx.converters.mil.Program
    :return: bool
    '''
