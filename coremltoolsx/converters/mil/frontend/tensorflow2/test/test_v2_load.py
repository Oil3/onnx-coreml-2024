...
from coremltoolsx.converters.mil.input_types import TensorType
from coremltoolsx.converters.mil.frontend.tensorflow.test.testing_utils import (
    get_tf_keras_io_names,
)
from coremltoolsx.converters.mil.frontend.tensorflow.test import (
    testing_utils as tf_testing_utils,
)
from coremltoolsx.converters.mil.frontend.tensorflow2.test.testing_utils import (
    make_tf2_graph
)
...
from coremltoolsx.converters.mil.frontend.tensorflow.test.test_load import (
    frontend,
...
class TestTf2ModelFormats:
    ...
    def test_model_metadata(self):
        ...
        assert "tensorflow==2." in metadata_keys["com.github.apple.coremltoolsx.source"]
