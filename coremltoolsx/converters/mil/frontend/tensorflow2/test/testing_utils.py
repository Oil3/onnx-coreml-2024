...
from coremltoolsx.converters.mil.input_types import TensorType, RangeDim
...
def run_compare_tf_keras(
    ...
    inputs_for_conversion: list of coremltoolsx.TensorType() or coremltoolsx.ImageType() objects
