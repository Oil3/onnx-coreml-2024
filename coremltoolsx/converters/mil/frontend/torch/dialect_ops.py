...
from coremltoolsx.converters.mil.mil import get_new_symbol, Operation, types
...
from coremltoolsx.converters.mil.mil.types.symbolic import is_compatible_symbolic_vector
