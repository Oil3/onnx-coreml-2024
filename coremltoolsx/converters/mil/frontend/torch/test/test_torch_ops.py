...
from coremltoolsx import RangeDim
from coremltoolsx.models.utils import _python_version
from coremltoolsx.models.utils import _macos_version
from coremltoolsx.converters.mil import testing_reqs

from coremltoolsx import TensorType
from coremltoolsx._deps import version_lt
...
class TestScriptedModels(TorchBaseTest):
    ...
    def test_conv(self, backend):
        pytest.xfail("rdar://88194776 ([Converter] coremltoolsx is not working with scripted torch convolution model)")
...
class TestAdaptiveMaxPool(TorchBaseTest):
    ...
    def test_adaptive_max_pool2d(
        ...
        # since coremltoolsx reproduces PyTorch's kernel sizes and
...
class StripCellAndHidden(nn.Module):
    ...
    def forward(self,x):
        # Pass tuple, not tensor, to avoid issue in coremltoolsx/converters/mil/frontend/torch/test/testing_utils.py on "if not expected_results:"
