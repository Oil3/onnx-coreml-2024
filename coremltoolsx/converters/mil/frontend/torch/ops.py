...
from coremltoolsx.converters.mil.mil.ops.defs.tensor_transformation import _solve_slice_by_index_shape
from coremltoolsx.converters.mil.mil.types import is_bool
from coremltoolsx.converters.mil.mil.types.symbolic import any_symbolic, is_symbolic, is_compatible_symbolic_vector
from coremltoolsx.converters.mil.mil.var import Var, ListVar
from coremltoolsx.converters.mil.mil.ops.defs._utils import MAX_SIZE_CONSTANT_FOLDING
...
def affine_grid_generator(context, node):
    # rdar://73165386 (Improve error handling of coremltoolsx "affine" op PyTorch conversion.)
