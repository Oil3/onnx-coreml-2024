...
from coremltoolsx.converters.mil.mil.passes.name_sanitization_utils import NameSanitizer
...
def _get_probability_var_for_classifier(prog, classifier_config):
    ...
    :param classifier_config: an instance of coremltoolsx.ClassifierConfig class
    :return: var
    '''
