...
from coremltoolsx.proto import NeuralNetwork_pb2
from coremltoolsx.converters.mil.mil.types.symbolic import (
    is_variadic,
    any_symbolic,
    is_symbolic,
)
from coremltoolsx.converters.mil.mil.types import np_dtype_to_py_type
    ...
    for op in _tqdm(ops, desc="Translating MIL ==> NeuralNetwork Ops", unit=" ops"):
        if op.op_type in custom_ops:
            ...
            msg = ("Op {} is used in the source model. This op is not supported "
                   ...
                   "Use coremltoolsx.convert(..., convert_to=\"mlprogram\") to convert to ML Program.\n"
                   "block: {}")
