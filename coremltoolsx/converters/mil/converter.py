...
from coremltoolsx.converters.mil.mil import Builder as mb
from coremltoolsx.converters.mil.mil.passes.quantization_passes import AbstractQuantizationPass
from coremltoolsx.converters.mil.mil.types.symbolic import k_used_symbols, k_num_internal_syms
from coremltoolsx.models import MLModel
from coremltoolsx.models.model import _create_mlpackage
from coremltoolsx.models.utils import _MLMODEL_EXTENSION, _MLPACKAGE_EXTENSION

try:
    from coremltoolsx.libmodelpackage import ModelPackage
...
def mil_convert(
    ...
    **kwargs
    ...
    Parameters
    ----------
    model: TF, PyTorch, or `coremltoolsx.converters.mil.Program`.
        See `coremltoolsx.converters.convert`
    ...
    Returns
    -------
    model: `coremltoolsx.models.MLModel` or
...
def mil_convert_to_proto(
    ...
    **kwargs
    ...
    if convert_to == 'milinternal':
        return None, prog # Returns (None, coremltoolsx.converters.mil.Program)
    ...
    return out, prog # Returns (Model_pb2.Model, coremltoolsx.converters.mil.Program)
