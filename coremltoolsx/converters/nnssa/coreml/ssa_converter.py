...
from coremltoolsx.models import datatypes
from coremltoolsx.proto import NeuralNetwork_pb2, Model_pb2
from coremltoolsx.models.neural_network import NeuralNetworkBuilder
from coremltoolsx.models.neural_network.flexible_shape_utils import set_multiarray_ndshape_range
...
def ssa_convert(ssa,
    ...
    custom_conversion_functions : dict of str -> function or empty dict
        ...
        Note that, It is custom conversion function's responsibility to add respective Core ML layer into builder (coremltoolsx's NeuralNetworkBuilder)
    ...
    if DEBUG:
        coremltoolsx.models.utils.save_spec(mlmodel_spec, '/tmp/model_from_spec.mlmodel')
...
class SSAConverter(object):
    ...
    def _convert_addn(self, node):
        ...
        # Blocked by a bug in coremltoolsx
