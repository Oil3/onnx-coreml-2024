...
from onnxx._custom_element_types import (
    bfloat16,
    float8e4m3fn,
    float8e4m3fnuz,
    float8e5m2,
...
from onnxx.defs import get_all_schemas_with_history, get_schema, onnx_opset_version
from onnxx.helper import make_node, make_tensor_type_proto, np_dtype_to_tensor_dtype
from onnxx.numpy_helper import to_array
from onnxx.onnx_pb import AttributeProto, GraphProto, NodeProto, TypeProto
...
class OpRun(abc.ABC):
    ...
    def make_node(
        ...
        **kwargs: Any,
        ...
        Method :meth:`eval <onnxx.reference.op_run.OpRun.eval>` creates an onnxx node
        returned by method :meth:`make_node <onnxx.reference.op_run.OpRun.make_node>`.
