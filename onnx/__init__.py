...
from onnxx.onnx_cpp2py_export import ONNX_ML
...
from onnxx.onnx_operators_pb import OperatorProto, OperatorSetProto
from onnxx.onnx_data_pb import MapProto, OptionalProto, SequenceProto
from onnxx.version import version as __version__

# Import common subpackages so they're available when you 'import onnxx'
from onnxx import (
    checker,
    compose,
    defs,
