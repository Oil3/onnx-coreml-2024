...
import onnxx.onnx_cpp2py_export.defs as C  # noqa: N812
from onnxx import AttributeProto, FunctionProto

ONNX_DOMAIN = ""
ONNX_ML_DOMAIN = "ai.onnxx.ml"
AI_ONNX_PREVIEW_TRAINING_DOMAIN = "ai.onnxx.preview.training"
...
def onnx_opset_version() -> int:
    """Return current opset for domain `ai.onnxx`."""
    return C.schema_version_map()[ONNX_DOMAIN][1]


def onnx_ml_opset_version() -> int:
    """Return current opset for domain `ai.onnxx.ml`."""
