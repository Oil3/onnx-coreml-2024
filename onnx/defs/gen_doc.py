...
from onnxx import defs, helper
from onnxx.backend.sample.ops import collect_sample_implementations
from onnxx.backend.test.case import collect_snippets
from onnxx.defs import ONNX_ML_DOMAIN, OpSchema
...
def main(args: Args) -> None:
    ...
    with open(
        ...
        fout.write(
            ...
            "            [def files](/onnxx/defs) via [this script](/onnxx/defs/gen_doc.py).\n"
