...
import onnxx
from onnxx import TensorProto, helper, numpy_helper, shape_inference
...
class TestTrainingTool(unittest.TestCase):
    def test_training_info_proto(self) -> None:
        ...
        # we can run onnxx checker to check if the full training graph is a valid
        ...
        onnxx.checker.check_model(full_training_model_with_shapes)
