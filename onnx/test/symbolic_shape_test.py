...
from onnxx import ModelProto, TensorProto, TensorShapeProto, ValueInfoProto, helper
from onnxx.helper import make_model, make_tensor_value_info
...
class TestSymbolicShape(unittest.TestCase):
    ...
    def test_concat_enable_symbolic(self) -> None:
        ...
        inferred_model = onnxx.shape_inference.infer_shapes(onnx_model, strict_mode=True)
