...
class ReferenceEvaluatorBackendRep(onnxx.backend.base.BackendRep):
...
class ReferenceEvaluatorBackend(onnxx.backend.base.Backend):
    @classmethod
...
# (see onnxx.reference.op_run.to_array_extended).
backend_test.exclude(
