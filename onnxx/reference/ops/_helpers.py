...
from onnxx.reference.op_run import OpRun, _split_class_name
...
def build_registered_operators_any_domain(
    ...
    if not reg_ops:
        raise RuntimeError(
            ...
            "of type 'OpRun' was detected. It may be due to an error during installation. Please try reinstalling onnxx."
        )
