...
from onnxx.reference.ops.aionnx_preview_training._op_run_training import OpRunTraining
from onnxx.reference.ops.aionnx_preview_training.op_adagrad import Adagrad
from onnxx.reference.ops.aionnx_preview_training.op_adam import Adam
from onnxx.reference.ops.aionnx_preview_training.op_momentum import Momentum
...
def load_op(
    ...
    if domain != "ai.onnxx.preview.training":
