...
"""onnxx version converter

This enables users to convert their models between different opsets within the
default domain ("" or "ai.onnxx").
"""
from __future__ import annotations

import onnxx
import onnxx.onnx_cpp2py_export.version_converter as C  # noqa: N812
...
def convert_version(model: ModelProto, target_version: int) -> ModelProto:
    ...
    return onnxx.load_from_string(converted_model_str)
