...
::
    ...
    python onnxx/test/reference_evaluator_test.py TestReferenceEvaluator.test_function_attribute_nested_graph
"""
...
import onnxx._custom_element_types as custom
from onnxx import (
    AttributeProto,
    FunctionProto,
    ModelProto,
...
from onnxx.backend.test.case.node.roialign import get_roi_align_input_values
from onnxx.checker import check_model
...
from onnxx.numpy_helper import float8e4m3_to_float32, float8e5m2_to_float32, from_array
from onnxx.reference import ReferenceEvaluator
from onnxx.reference.op_run import OpRun, OpRunExpand
from onnxx.reference.ops import load_op
from onnxx.reference.ops._op_common_indices import _get_indices, _is_out
from onnxx.reference.ops._op_list import Cast_19, Celu
from onnxx.reference.ops.aionnx_preview_training._op_list import Adam
from onnxx.reference.ops.op_celu import _vcelu1
from onnxx.reference.ops.op_col2im import (
    _col2im_naive_implementation_2d,
    col2im_naive_implementation,
)
from onnxx.reference.ops.op_conv import Conv, _conv_implementation
from onnxx.reference.ops_optimized import Conv as ConvOptimized
from onnxx.reference.ops_optimized.op_conv_optimized import _conv_implementation_im2col
