...
from onnxx.helper import float32_to_float8e4m3, float32_to_float8e5m2, make_tensor
from onnxx.numpy_helper import float8e4m3_to_float32, float8e5m2_to_float32
        ...
        for from_type, to_type in test_cases:
            ...
            if from_type == "BFLOAT16" or to_type == "BFLOAT16":
                ...
                if to_type == "BFLOAT16":
                    ...
                    input_type_proto = onnxx.helper.make_tensor_type_proto(
                        int(TensorProto.FLOAT), input.shape
                    )
                    output_type_proto = onnxx.helper.make_tensor_type_proto(
            ...
            if input_type_proto and output_type_proto:
                like_type_proto = onnxx.helper.make_tensor_type_proto(
