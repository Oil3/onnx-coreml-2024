...
autogen_header = """\
//
// WARNING: This file is automatically generated!  Please edit onnxx.in.proto.
//
...
def convert(
    ...
    # We do not want to generate the onnxx-data-ml.proto files for onnxx-data.in.proto,
    # as there is no change between onnxx-data.proto and the ML version.
    if "onnxx-data" in proto_in:
        do_onnx_ml = False
    if do_onnx_ml:
...
def main() -> None:
    ...
    parser.add_argument(
        "stems",
        nargs="*",
        default=["onnxx", "onnxx-operators", "onnxx-data"],
